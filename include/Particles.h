...
/** particle mover */
int mover_PC_basic(struct particles*, struct EMfield*, struct grid*, struct parameters*);

/** Interpolation Particle --> Grid: This is for species */
void interpP2G(struct particles*, struct interpDensSpecies*, struct grid*);

/** particle mover for GPU without batching*/
int mover_GPU_basic(struct particles*, struct EMfield*, struct grid*, struct parameters*);
